...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Staffs Trash</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Staffs Trash</h6>
        </div>
        <div class="card-body">
...
@section('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.mi_submit_restore', function (e) {
            ...
            window.location.href = "{{ url('/admin/staff_restore') }}/"+ids.join(',');
        });
    </script>
@endsection
